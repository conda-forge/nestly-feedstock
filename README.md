About nestly-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nestly-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=675&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nestly-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nestly` can be installed with `conda`:
...
```
mamba install nestly
```

It is possible to list all of the versions of `nestly` available on your platform with `conda`:
...
```
mamba search nestly --channel conda-forge
```
...
mamba repoquery search nestly --channel conda-forge

# List packages depending on `nestly`:
mamba repoquery whoneeds nestly --channel conda-forge

# List dependencies of `nestly`:
mamba repoquery depends nestly --channel conda-forge
```
